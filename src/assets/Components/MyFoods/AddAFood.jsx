...
const AddAFood = () => {
    ...
    const handleUpdate =e=>{
        ...
        // const foodDonatorEmail=email 
        // const foodDonatorImage=image 
        // const foodDonatorName=name
const foods ={additionalNotes,expiredDateInDays,foodImage,foodName,foodQuantity,pickupLocation}
        console.log(additionalNotes,expiredDateInDays,foodImage,foodName,foodQuantity,pickupLocation)
        axios.post('http://localhost:5000/RizkShare/availableFoods',)
    }
